...
class DeviceTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('m_device_translation')->insert([
            ...
            ['name' => 'CL4-Can Conveyer From Pasteurizer To Wrap Around And FHIs', 'translation_id' => 7, 'language_id' => 2 ],
            ['name' => 'CL4-Can Conveyer From Pasteurizer To Wrap Around And FHIs', 'translation_id' => 7, 'language_id' => 1 ],
            ['name' => 'CL4-Can Crusher', 'translation_id' => 8, 'language_id' => 2 ],
            ['name' => 'CL4-Can Crusher', 'translation_id' => 8, 'language_id' => 1 ],
            ['name' => 'CL4-Carton Conveyer From Wrap Around 01 To Divider', 'translation_id' => 9, 'language_id' => 2 ],
            ['name' => 'CL4-Carton Conveyer From Wrap Around 01 To Divider', 'translation_id' => 9, 'language_id' => 1 ],
            ['name' => 'CL4-Carton Conveyer From Wrap Around 02 To Divider', 'translation_id' => 10, 'language_id' => 2 ],
            ['name' => 'CL4-Carton Conveyer From Wrap Around 02 To Divider', 'translation_id' => 10, 'language_id' => 1 ],

            ['name' => 'KL6-Plate Chain Conveyer From Filler To Palletizer', 'translation_id' => 11, 'language_id' => 2 ],
            ['name' => 'KL6-Plate Chain Conveyer From Filler To Palletizer', 'translation_id' => 11, 'language_id' => 1 ],
            ['name' => 'KL6-Keg Palletizer', 'translation_id' => 12, 'language_id' => 2 ],
            ['name' => 'KL6-Keg Palletizer', 'translation_id' => 12, 'language_id' => 1 ],
            ['name' => 'KL6-Roller Conveyor Segment', 'translation_id' => 13, 'language_id' => 2 ],
            ['name' => 'KL6-Roller Conveyor Segment', 'translation_id' => 13, 'language_id' => 1 ],
            ['name' => 'KL6-Plate Chain Conveyer Segment', 'translation_id' => 14, 'language_id' => 2 ],
            ['name' => 'KL6-Plate Chain Conveyer Segment', 'translation_id' => 14, 'language_id' => 1 ],
        ]);
    }
}
