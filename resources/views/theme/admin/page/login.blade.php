@extends('theme.layout.main_blank')
...
@section('page_content')
    <div class="signin-wrapper">
        ...
        <form id="loginForm">
                <h2 class="slim-logo text-center"><img src="{{asset('/img/app/logo.jpg')}}" width="80%" alt="logo"></h2>
                ...
                <div class="form-group mg-b-50">
                    ...
                    data-parsley-minlength="3" data-parsley-minlength-message="Password at least 3 characters.">
                </div><!-- form-group -->
